...
grid2.tiles[2][4] = "red";
let dot3 = new Dots();
dot3.yellowDot(150, 150);
grid2.tiles[1][1] = "yellow";
let dot4 = new Dots();
dot4.yellowDot(450, 50);
grid2.tiles[0][4] = "yellow";
let dot5 = new Dots();
dot5.blueDot(150, 350);
grid2.tiles[3][1] = "blue";
let dot6 = new Dots();
dot6.blueDot(350, 350);
grid2.tiles[3][3] = "blue";
let dot7 = new Dots();
dot7.greenDot(150, 50);
grid2.tiles[0][1] = "green";
let dot8 = new Dots();
dot8.greenDot(450, 150);
grid2.tiles[1][4] = "green";
...
function onMouseClick(e) {
  ...
  if (congrats) {
    ...
    window.location.href = "easy_level_6.html";
  }
}
...
let answerKey = [["green", "green", "yellow", "yellow", "yellow"],
