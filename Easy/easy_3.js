...
let dot4 = new Dots();
dot4.yellowDot(150, 250);
grid2.tiles[2][1] = "yellow";
let dot5 = new Dots();
...
let dot7 = new Dots();
dot7.greenDot(150, 450);
grid2.tiles[4][1] = "green";
let dot8 = new Dots();
dot8.greenDot(450, 450);
grid2.tiles[4][4] = "green";
let dot9 = new Dots();
dot9.orangeDot(150, 150);
grid2.tiles[1][1] = "orange";
let dot10 = new Dots();
dot10.orangeDot(250, 350);
grid2.tiles[3][2] = "orange";
...
function onMouseClick(e) {
  ...
  if (congrats) {
    ...
    window.location.href = "easy_level_4.html";
  }
}
...
let answerKey = [["red", "red", "orange", "orange", "orange"],
                 ["red", "orange", "orange", "blue", "orange"],
                 ["red", "yellow", "blue", "blue", "orange"],
