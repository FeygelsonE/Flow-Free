...
grid2.tiles[0][4] = "red";
let dot3 = new Dots();
dot3.yellowDot(250, 450);
grid2.tiles[4][2] = "yellow";
let dot4 = new Dots();
dot4.yellowDot(450, 350);
grid2.tiles[3][4] = "yellow";
let dot5 = new Dots();
dot5.blueDot(350, 350);
grid2.tiles[3][3] = "blue";
let dot6 = new Dots();
dot6.blueDot(50, 450);
grid2.tiles[4][0] = "blue";
let dot7 = new Dots();
dot7.greenDot(50, 50);
...
let dot9 = new Dots();
dot9.orangeDot(50, 350);
grid2.tiles[3][0] = "orange";
let dot10 = new Dots();
...
function onMouseClick(e) {
  ...
  if (congrats) {
    ...
    window.location.href = "easy_level_5.html";
  }
}
...
let answerKey = [["green", "red", "red", "red", "red"],
                ["green", "green", "green", "green", "green"],
                ["orange", "orange", "orange", "orange", "green"],
                ["orange", "blue", "blue", "blue", "yellow"],
